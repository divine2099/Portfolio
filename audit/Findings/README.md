...
| Morpho Midnight | Cantina | Solidity / EVM | Fixed-rate lending review; duplicate reconciliation and a self-debunked cross-contract reentrancy | [morpho_findings.md](morpho_findings.md) |
